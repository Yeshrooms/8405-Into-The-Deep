...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2310.3620975439426; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1495.627563201914; // x position of the perpendicular encoder (in tick units)
    }
